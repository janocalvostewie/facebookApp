 ...
 * @author Jano
 */
public class CargaFoto extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargaFoto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
